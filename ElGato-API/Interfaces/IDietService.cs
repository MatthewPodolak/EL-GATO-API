...
namespace ElGato_API.Interfaces
{
    public interface IDietService
    {
        ...
        Task<ErrorResponse> AddIngridientToMeal(string userId, AddIngridientVM model);
        ...
        Task<(List<IngridientVMO>? ingridients, ErrorResponse error)> GetListOfIngridientsByName(string name);
