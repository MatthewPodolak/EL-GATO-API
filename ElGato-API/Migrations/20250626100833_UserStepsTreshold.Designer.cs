...
namespace ElGato_API.Migrations
{
    ...
    [Migration("20250626100833_UserStepsTreshold")]
    partial class UserStepsTreshold
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ElGato_API.Models.Requests.ReportedUsers", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ElGato_API.Models.User.UserBadges", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ElGato_API.Models.User.UserFollowerRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ElGato_API.Models.User.UserBadges", b =>
                {
                    b.HasOne("ElGato_API.Models.Feed.Challange", "Challange")
                        .WithMany()
            ...
            modelBuilder.Entity("ElGato_API.Models.User.UserFollower", b =>
                {
                    ...
                    b.HasOne("ElGato_API.Models.User.AppUser", "Follower")
                        .WithMany("Following")
            ...
            modelBuilder.Entity("ElGato_API.Models.User.UserFollowerRequest", b =>
                {
                    b.HasOne("ElGato_API.Models.User.AppUser", "Requester")
                        .WithMany("SentFollowRequests")
                        .HasForeignKey("RequesterId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("ElGato_API.Models.User.AppUser", "Target")
